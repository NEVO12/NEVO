...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SAYAKU.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SAY", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SAYAKU -X kill
screen -S SAYAKU ./SAYAKU
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SAYAKUIQ/Files_SAYAKU/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1272276356,1278793778}   
...
local SAYAKU_Msg = ''  
if msgs < 100 then 
SAYAKU_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SAYAKU_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SAYAKU_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SAYAKU_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SAYAKU_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SAYAKU_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SAYAKU_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SAYAKU_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SAYAKU_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SAYAKU_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SAYAKU_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SAYAKU_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SAYAKU_Msg = 'رب التفاعل'  
end 
return SAYAKU_Msg 
end
...
function plugin_Amer(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Amer and msg then
pre_msg = plugin.Amer(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSAYAKU(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SAYAKU_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SAYAKU.lua')
os.execute('wget https://raw.githubusercontent.com/NEVO12/SAYAKU/master/SAYAKU.lua')
...
send(msg.chat_id_, msg.id_,'❒⇠  عدد الكروبات الان » { '..#group..' }'..SAYAKUk..''..SAYAKU..'\n❒⇠  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❒⇠ العضو » ['..result.title_..'](t.me/'..(username or 'iKkKkil')..')'
status  = '\n ❒⇠ تم ترقيته مطور'
...
usertext = '\n ❒⇠ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'iKkKkil')..')'
status  = '\n ❒⇠ تم ترقيته مطور'
...
local SAYAKU1_Msg = database:get(bot_id.."SAYAKU1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SAYAKU1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❒⇠ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'iKkKkil')..') \n ❒⇠ '..SAYAKU1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SAYAKU_Msg and not Special(msg) then  
local SAYAKU_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SAYAKU_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❒⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❒⇠ ["..SAYAKU_Msg.."] \n")
else
send(msg.chat_id_,0," ❒⇠ العضو : {["..data.first_name_.."](T.ME/iKkKkil)}\n ❒⇠ ["..SAYAKU_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❒⇠ عذرا » {["..data.first_name_.."](T.ME/iKkKkil)}\n ❒⇠ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━━━━━━━━≫
 ❒⇠ ↬SAYAKU TEAM
 ≪━━━━━━━━━━━━━≫
 ❒⇠ ↬[Channel SAYAKU](t.me/iKkKkil) 
≪━━━━━━━━━━━━━≫
 ❒⇠ ↬[DEVELOPER](t.me/G00ll)
≪━━━━━━━━━━━━━≫
 ❒⇠ ↬[The way his inauguration](https://t.me/iKkKkil)
≪━━━━━━━━━━━━━≫
 ❒⇠ ↬[To talk to us](t.me/kkkkoiBot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❒⇠ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'iKkKkil')..') \n ❒⇠ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❒⇠ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'iKkKkil')..') \n ❒⇠ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❒⇠ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'iKkKkil')..')'
status  = '\n ❒⇠ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❒⇠ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❒⇠ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'iKkKkil')..')'
...
database:set(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❒⇠ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SAYAKU1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SAYAKU1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❒⇠ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SAYAKU1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SAYAKU1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SAYAKU1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❒⇠ ارسل الكلمه الان")  
database:set(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SAYAKU1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SAYAKU1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SAYAKU1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SAYAKU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SAYAKU1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SAYAKU1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❒⇠ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local SAYAKU_Msg = database:get(bot_id.."SAYAKU1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SAYAKU_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❒⇠ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'iKkKkil')..')'..'\n ❒⇠ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..SAYAKU_Msg[math.random(#SAYAKU_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'iKkKkil')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SAYAKUdx(msg.chat_id_, msg.id_, ' ❒⇠ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❒⇠ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❒⇠ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❒⇠ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
❒⇠رفع  تنزيل ⇜ادمن بكل الصحلاحيات
❒⇠رفع  تنزيل ⇜القيود 
❒⇠رفع  تنزيل ⇜تنزيل جميع الرتب
-------------------------------------------------------------
✮︙اوامر تغير اسماء ⇠الرتب
-------------------------------------------------------------
❒⇠تغير  رد⇽المطور +اسم
❒⇠تغير  رد⇽منشئ اساسي +اسم
❒⇠تغير  رد⇽المنشئ +اسم
❒⇠تغير  رد⇽المدير +اسم
❒⇠تغير. رد⇽الادمن +اسم
❒⇠تغير  رد⇽ المميز +اسم
...
❒︙⇠ اوامر المجموعه ⇣
-------------------------------------------------------------
❒⇠تاك ⇜ المميزين الئ.⇠ المنشئين الاساسين
❒⇠كشف القيود ⇜ تعين الايدي
❒⇠تنظيف ⇜ العدد
❒⇠منع⇜ برد ⇠صوره -متحركه -ملصق
❒⇠حظر ⇠ كتم ⇠ تقيد ⇠طرد ⇜برد
❒⇠المحظورين ⇠المكتومين ⇠المقيدين   
-------------------------------------------------------------
❒⇠تقيد⇠كتم + الرقم +ساعه او يوم او دقيقه
❒⇠تثبيت ⇠ الغاء تثبيت
❒⇠الترحيب
❒⇠كشف البوتات
❒⇠الصلاحياتي
...
SAYAKU = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SAYAKU)
...
--------------------------------------------------------------------------------------------------------------
SourceSAYAKU(data.message_,data)
plugin_Amer(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local SAYAKUAbot = database:get(bot_id.."SAYAKU1:Add:Filter:Rp2"..text..result.chat_id_)   
if SAYAKUAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❒⇠ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❒⇠ ["..SAYAKUAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SAYAKU1_Msg = database:get(bot_id.."SAYAKU1:Add:Filter:Rp2"..text..result.chat_id_)   
if SAYAKU1_Msg then    
send(msg.chat_id_, msg.id_," ❒⇠ "..SAYAKU1_Msg)
